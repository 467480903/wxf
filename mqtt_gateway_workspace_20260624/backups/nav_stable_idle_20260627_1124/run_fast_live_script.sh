...
export G2_WXF_GATEWAY_PREFLIGHT="${G2_WXF_GATEWAY_PREFLIGHT:-skip}"
...
export G2_WXF_NAV_IDLE_WAIT_POLL_S="${G2_WXF_NAV_IDLE_WAIT_POLL_S:-0.25}"
export G2_WXF_NAV_IDLE_STABLE_S="${G2_WXF_NAV_IDLE_STABLE_S:-1.0}"
...
export G2_WXF_FAST_HEAD_SPEED_RADPS="${G2_WXF_FAST_HEAD_SPEED_RADPS:-0.3}"
export G2_WXF_FAST_WAIST_SPEED_RADPS="${G2_WXF_FAST_WAIST_SPEED_RADPS:-0.3}"
export G2_WXF_FAST_ARM_SPEED_RADPS="${G2_WXF_FAST_ARM_SPEED_RADPS:-0.2}"
export G2_WXF_FAST_BODY_INTER_COMMAND_DELAY_S="${G2_WXF_FAST_BODY_INTER_COMMAND_DELAY_S:-0}"
export G2_WXF_FAST_BODY_SETTLE_S="${G2_WXF_FAST_BODY_SETTLE_S:-0}"
export G2_WXF_FAST_WHOLE_BODY_SPLIT="${G2_WXF_FAST_WHOLE_BODY_SPLIT:-1}"
export G2_WXF_FAST_WHOLE_BODY_SPLIT_DELAY_S="${G2_WXF_FAST_WHOLE_BODY_SPLIT_DELAY_S:-0.08}"
export G2_WXF_FAST_WHOLE_BODY_SKIP_HEAD="${G2_WXF_FAST_WHOLE_BODY_SKIP_HEAD:-0}"
export G2_WXF_FAST_GRIPPER_INTER_SIDE_DELAY_S="${G2_WXF_FAST_GRIPPER_INTER_SIDE_DELAY_S:-0}"
export G2_WXF_FAST_GRIPPER_POST_WAIT_S="${G2_WXF_FAST_GRIPPER_POST_WAIT_S:-0}"
export G2_WXF_FAST_GRIPPER_FORCE_SEQUENTIAL="${G2_WXF_FAST_GRIPPER_FORCE_SEQUENTIAL:-0}"
export G2_WXF_FAST_SKIP_TTS="${G2_WXF_FAST_SKIP_TTS:-0}"
export G2_WXF_FINAL_LEFT_OPEN_RETRY="${G2_WXF_FINAL_LEFT_OPEN_RETRY:-0}"
export G2_WXF_FINAL_LEFT_OPEN_RETRY_DELAY_S="${G2_WXF_FINAL_LEFT_OPEN_RETRY_DELAY_S:-0}"
export G2_WXF_FAST_EE_MAX_STEP_M="${G2_WXF_FAST_EE_MAX_STEP_M:-0.001}"
export G2_WXF_FAST_EE_RATE_HZ="${G2_WXF_FAST_EE_RATE_HZ:-50}"
export G2_WXF_FAST_EE_LIFE_TIME_S="${G2_WXF_FAST_EE_LIFE_TIME_S:-0.02}"
export G2_WXF_FAST_EE_INTER_SIDE_DELAY_S="${G2_WXF_FAST_EE_INTER_SIDE_DELAY_S:-0.002}"
export G2_WXF_FAST_EE_USE_BOTH_GROUP="${G2_WXF_FAST_EE_USE_BOTH_GROUP:-0}"
...
echo "# fast_demo: head=${G2_WXF_FAST_HEAD_SPEED_RADPS} waist=${G2_WXF_FAST_WAIST_SPEED_RADPS} arm=${G2_WXF_FAST_ARM_SPEED_RADPS} ee_step=${G2_WXF_FAST_EE_MAX_STEP_M} ee_rate=${G2_WXF_FAST_EE_RATE_HZ} skip_tts=${G2_WXF_FAST_SKIP_TTS} gripper_seq=${G2_WXF_FAST_GRIPPER_FORCE_SEQUENTIAL} final_left_retry=${G2_WXF_FINAL_LEFT_OPEN_RETRY}"
