...
export G2_WXF_FAST_GRIPPER_INTER_SIDE_DELAY_S="${G2_WXF_FAST_GRIPPER_INTER_SIDE_DELAY_S:-0.10}"
export G2_WXF_FAST_GRIPPER_POST_WAIT_S="${G2_WXF_FAST_GRIPPER_POST_WAIT_S:-0.20}"
export G2_WXF_FAST_GRIPPER_FORCE_SEQUENTIAL="${G2_WXF_FAST_GRIPPER_FORCE_SEQUENTIAL:-1}"
export G2_WXF_FAST_SKIP_TTS="${G2_WXF_FAST_SKIP_TTS:-1}"
export G2_WXF_FINAL_LEFT_OPEN_RETRY="${G2_WXF_FINAL_LEFT_OPEN_RETRY:-1}"
export G2_WXF_FINAL_LEFT_OPEN_RETRY_DELAY_S="${G2_WXF_FINAL_LEFT_OPEN_RETRY_DELAY_S:-0.10}"
export G2_WXF_FAST_EE_MAX_STEP_M="${G2_WXF_FAST_EE_MAX_STEP_M:-0.0005}"
export G2_WXF_FAST_EE_RATE_HZ="${G2_WXF_FAST_EE_RATE_HZ:-100}"
export G2_WXF_FAST_EE_LIFE_TIME_S="${G2_WXF_FAST_EE_LIFE_TIME_S:-0.02}"
export G2_WXF_FAST_EE_INTER_SIDE_DELAY_S="${G2_WXF_FAST_EE_INTER_SIDE_DELAY_S:-0}"
export G2_WXF_FAST_EE_USE_BOTH_GROUP="${G2_WXF_FAST_EE_USE_BOTH_GROUP:-1}"
