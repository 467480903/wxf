...
echo "# fast_demo: head=${G2_WXF_FAST_HEAD_SPEED_RADPS} waist=${G2_WXF_FAST_WAIST_SPEED_RADPS} arm=${G2_WXF_FAST_ARM_SPEED_RADPS} ee_step=${G2_WXF_FAST_EE_MAX_STEP_M} ee_rate=${G2_WXF_FAST_EE_RATE_HZ} skip_tts=${G2_WXF_FAST_SKIP_TTS} gripper_seq=${G2_WXF_FAST_GRIPPER_FORCE_SEQUENTIAL}"
