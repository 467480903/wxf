...
export G2_WXF_FAST_GRIPPER_INTER_SIDE_DELAY_S="${G2_WXF_FAST_GRIPPER_INTER_SIDE_DELAY_S:-0.15}"
export G2_WXF_FAST_GRIPPER_POST_WAIT_S="${G2_WXF_FAST_GRIPPER_POST_WAIT_S:-0.30}"
...
echo "# fast_demo: head=${G2_WXF_FAST_HEAD_SPEED_RADPS} waist=${G2_WXF_FAST_WAIST_SPEED_RADPS} arm=${G2_WXF_FAST_ARM_SPEED_RADPS} ee_step=${G2_WXF_FAST_EE_MAX_STEP_M} ee_rate=${G2_WXF_FAST_EE_RATE_HZ}"
