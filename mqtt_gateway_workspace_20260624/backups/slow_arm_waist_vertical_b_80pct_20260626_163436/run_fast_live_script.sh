...
export G2_WXF_FAST_HEAD_SPEED_RADPS="${G2_WXF_FAST_HEAD_SPEED_RADPS:-0.5}"
export G2_WXF_FAST_WAIST_SPEED_RADPS="${G2_WXF_FAST_WAIST_SPEED_RADPS:-1.0}"
export G2_WXF_FAST_ARM_SPEED_RADPS="${G2_WXF_FAST_ARM_SPEED_RADPS:-0.5}"
...
export G2_WXF_FAST_WHOLE_BODY_SKIP_HEAD="1"
