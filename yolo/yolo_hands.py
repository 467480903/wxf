...
results[0].save(filename='result_hands.jpg')
...
if pt1 is not None and pt2 is not None:
    ...
    cv2.imwrite('result_hands_line.jpg', img)
    print("线段绘制完成，已保存到 result_hands_line.jpg")
    ...
    with open('yolo_hands_result.json', 'w') as f:
        json.dump(result_data, f, indent=4)
    print("Results saved to yolo_hands_result.json")
