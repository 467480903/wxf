...
TASK_SEQUENCE = [
    "python move_whole_body_client.py /data/wxf/wxf/positions/pick_standby.json",
    
    "python move_whole_body_client.py /data/wxf/wxf/positions/car_grab_5.json",
    "python move_whole_body_client.py /data/wxf/wxf/positions/car_grab_4.json",
    "python move_whole_body_client.py /data/wxf/wxf/positions/car_grab_5.json",
    "python move_whole_body_client.py /data/wxf/wxf/positions/pick_standby.json",
