...
# 第一组目标位姿（位置和四元数）
TARGET1_LEFT_POSITION = [ 0.7048, 0.1224, 0.8008]
TARGET1_LEFT_ORIENTATION = [ -0.4228,  0.5536, -0.5152, 0.4993]


# 第二组目标位姿
TARGET2_LEFT_POSITION = [0.6934, 0.3123, 0.8028]
TARGET2_LEFT_ORIENTATION = [ -0.5132, 0.5309, -0.4723, 0.4814]
