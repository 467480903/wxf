...
SERVICES=(
    "g2_minth_app_service|mqtt/g2_minth_app_service.py"
    "camera|mqtt/camera.py"
    "g2_minth_data_service|mqtt/g2_minth_data_service.py"
    "g2_minth_status_publisher|mqtt/g2_minth_status_publisher.py"
...
# ── 启动 ──────────────────────────────────────────────────
start_service() {
    # 入参格式：name|relative_path
    local entry="$1"
    local name="${entry%%|*}"
    local rel_path="${entry##*|}"
    local py_file="$PROJECT_DIR/$rel_path"
